...
def _():
    ...
    return RFECV, StratifiedKFold, train_test_split
...
def _():
    ...
    return auc, classification_report, confusion_matrix, roc_curve
...
def _(mo, reduced_data):
    ...
    return cat_encoders, catagorical_cols
...
def _(LabelEncoder, OneHotEncoder, pd):
    ...
    def get_encoder_from_ui(cat_encoders, catagorical_cols):
        ...
        return col_encoders
    return get_encoder_from_ui, to_numeric
...
def _(
    ...
    return class_weight_dict, rfecv
